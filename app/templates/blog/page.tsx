  ...
  const recentPosts = [
    {
      ...
      readTime: "6 min read",
      image: "/placeholder.svg?height=200&width=300&text=Post+1",
    },
    {
      id: 2,
      title: "The Future of CSS: What's Coming in 2025",
      excerpt: "Explore the upcoming CSS features that will revolutionize web design in the coming year.",
      date: "March 5, 2025",
      author: {
        name: "Taylor Wilson",
        avatar: "/placeholder.svg?height=40&width=40",
      ...
      category: "CSS",
      readTime: "5 min read",
      image: "/placeholder.svg?height=200&width=300&text=Post+2",
    },
    {
      id: 3,
      ...
      readTime: "7 min read",
      image: "/placeholder.svg?height=200&width=300&text=Post+3",
    },
  ]
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Insights, tutorials, and news about web development, programming, and technology.
          </p>
        </header>
              ...
              <CardContent>
                <div className="flex flex-col items-center text-center mb-4">
                  <Avatar className="h-20 w-20 mb-4">
                    <AvatarImage src="/placeholder.svg?height=80&width=80" alt="Blog Author" />
                    <AvatarFallback>BL</AvatarFallback>
                  </Avatar>
                  <h3 className="font-bold text-lg">The Dev Team</h3>
                  <p className="text-sm text-muted-foreground">
                    We&apos;re a team of developers sharing our knowledge and experiences.
                  </p>
                </div>
                <Separator className="my-4" />
                <p className="text-sm text-muted-foreground">
                  This blog is dedicated to sharing insights, tutorials, and news about web development, programming,
                  and technology. Join us on this journey of continuous learning.
                </p>
              </CardContent>
              <CardFooter>
