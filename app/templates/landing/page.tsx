...
export default function LandingTemplate() {
  const features = [
    {
      ...
      description: "Our user-friendly interface makes it easy to navigate and find what you need quickly.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description: "Stay ahead with continuous improvements and new features delivered regularly.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
  ...
  const testimonials = [
    ...
    {
      quote: "The customer support is exceptional. Any questions we had were answered promptly and thoroughly.",
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                The all-in-one solution for teams to collaborate, manage projects, and boost productivity.
              </p>
            ...
            <div className="relative">
              ...
              <img
                src="/placeholder.svg?height=600&width=600&text=Platform+Screenshot"
        ...
        <section className="py-12 md:py-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Join thousands of companies using our platform to improve their workflow
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground">
                  Create your account and set up your team in minutes. No technical knowledge required.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-2xl font-bold mb-4">
                ...
                <p className="text-muted-foreground">
                  Easily import your existing data or start fresh with our intuitive templates.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-2xl font-bold mb-4">
                ...
                <p className="text-muted-foreground">
                  Invite your team members and start collaborating in real-time on your projects.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-xl opacity-80 mb-6">
                  Transform your workflow today with our all-in-one platform. Start your free trial now.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="hidden md:block">
                <img
                  src="/placeholder.svg?height=300&width=500&text=Dashboard+Preview"
