          ...
          <div className='grid md:grid-cols-2 gap-8 items-center'>
            <div>
              ...
              <div className='flex gap-4 mt-8'>
                ...
                <Button variant='ghost' size='icon' asChild>
                  <Link href={`mailto:${emailAdrress}`} target='_blank'>
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            <div className='space-y-6'>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  <h3 className='font-medium mb-1'>Email</h3>
                  <a href='mailto:vijayg963@gmail.com'>
                    <p className='text-muted-foreground'>vijayg963@gmail.com</p>
                  </a>
                </div>
              </div>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground'>+91 8950307535</p>
                </div>
              </div>
              <div className='pt-4'>
            ...
            <div id='contactMeForm'>
              <h2 className='text-center text-2xl md:text-3xl p-4 pt-0'>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className='space-y-4'>
                  ...
                  <div className='flex justify-center p-4'>
                    <button
                      type='submit'
                      className=' rounded-md border py-2 px-5 m-4'
                    >
                      Send Message
                    </button>
                  </div>
